(function(window, document, undefined) {
  ...
  describe('Localization directive', function() {
    ...
    var createTestEnv = function(keyString, varsString) {
      angular.mock.inject(function($injector) {
        ...
        element = angular.element(
          '<localize ng-app key="' + keyString + '" vars="' + varsString + '"></localize>'
        );
    ...
    it('updates a string w/ a single string variable when the current language changes', function() {
      createTestEnv( 'key', "'test'" );
      expect( element.innerText ).toEqual( localize('key', 'test') );
    ...
    it('updates a string w/ an array of strings when the current language changes', function() {
      createTestEnv( 'key', "['string 1', 'string 2']" );
      expect( element.innerText ).toEqual( localize('key', 'string 1', 'string 2') );
    ...
    it('updates a string w/ a single $scope variable when the current language changes', function() {
      $scope.scopeVar = 'test';
      createTestEnv( 'key', 'scopeVar' );
    ...
    it('updates a string w/ a single $scope variable when the $scope variable changes', function() {
      $scope.scopeVar = 'test';
      createTestEnv( 'key', 'scopeVar' );
    ...
    it('updates a string w/ an array of $scope variables when the current language changes', function() {
      $scope.scopeVar1 = 'string 1';
      $scope.scopeVar2 = 'string 2';
      createTestEnv( 'key', "[scopeVar1, scopeVar2]" );
    ...
    it('updates a string w/ an array of $scope variables when the $scope variables change', function() {
      $scope.scopeVar1 = 'string 1';
      $scope.scopeVar2 = 'string 2';
      createTestEnv( 'key', "[scopeVar1, scopeVar2]" );
